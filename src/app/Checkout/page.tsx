...
const sanityClient = createClient({
  projectId: "b3dyryg2", // Replace with your Sanity Project ID
  dataset: "production", // or your dataset name
  useCdn: true,
  apiVersion: "2025-01-26",
  token:
    "skMXl55el1mVhgPlmo7ILCuNdaF2vvVMRExdbpu7QJvvh9FMbhQ7zJXveRs89VtCE6TEwm6r6djbZkvRfflSbNlra5FsW6RmIP0cOEc8y8vrXi2IfvN3WOWCdCaZNZe8pzbc1cHFruUpHUjUvfKFOxhehbutKrg4W9hLKohJHNqRibiwpMhD", // Replace with your token
});
...
const CheckoutPage = () => {
  ...
  const handleOrderConfirm = async (event: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("🎉 Order Confirmed & Saved to Sanity!", {
        position: "top-right",
        autoClose: 3000,
      });
