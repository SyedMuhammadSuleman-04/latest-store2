...
//       {/* Sidebar: Make it smaller */}
//       <aside className="w-1/6 bg-gray-400 shadow-lg p-4 rounded-lg">
//         <h2 className="text-xl font-semibold mb-4 text-black">Filters</h2>

//         {/* Category Filters */}
//         <div className="mb-6">
//           <h3 className="text-lg font-medium mb-2 text-black">Category</h3>
//           <ul className="space-y-2">
...
//       {/* Main Content: Make the product section bigger */}
//       <main className="flex-1 p-6">
//         <ProductList products={products} className="text-black" />
//       </main>
//     </div>
//   );
// }
